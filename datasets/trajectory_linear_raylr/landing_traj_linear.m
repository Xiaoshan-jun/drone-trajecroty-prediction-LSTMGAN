...
for i = 241 : 265 %trajectory number
    if mod(i,8) == 0
    state = [400 + 200*(raylrnd(0.5)-0.5) , 400 + 200*(raylrnd(0.5)-0.5), 140 + 15*(raylrnd(0.5)-0.5)];
    elseif mod(i,8) == 1
    state = [-400 + 200*(raylrnd(0.5)-0.5) , 400 + 200*(raylrnd(0.5)-0.5), 140 + 15*(raylrnd(0.5)-0.5)];
    elseif mod(i,8) == 2
    state = [400 + 200*(raylrnd(0.5)-0.5) , -400 + 200*(raylrnd(0.5)-0.5), 140 + 15*(raylrnd(0.5)-0.5)];
    elseif mod(i,8)== 3
    state = [200*(raylrnd(0.5)-0.5) , 400 + 200*(raylrnd(0.5)-0.5), 140 + 15*(raylrnd(0.5)-0.5)];
    elseif mod(i,8) == 4
    state = [400 + 200*(raylrnd(0.5)-0.5) , 200*(raylrnd(0.5)-0.5), 140 + 15*(raylrnd(0.5)-0.5)];
    elseif mod(i,8) == 5
    state = [200*(raylrnd(0.5)-0.5) , -400 + 200*(raylrnd(0.5)-0.5), 140 + 15*(raylrnd(0.5)-0.5)];
    elseif mod(i,8) == 6
    state = [-400 + 200*(raylrnd(0.5)-0.5) , 200*(raylrnd(0.5)-0.5), 140 + 15*(raylrnd(0.5)-0.5)];
...
%     fileID = fopen(filename,'w');
    for t = 1 : 20
        ...
        if mod(i,4) == 0
        xv = max(-mvx , vb(1) + 15 * (raylrnd(0.5) - 0.5));
        yv = max(-mvy, vb(2) + 15*(raylrnd(0.5) - 0.5));
        elseif mod(i,4) == 1
        xv = min(mvx , vb(1) + 15 * (raylrnd(0.5) - 0.5));
        yv = max(-mvy, vb(2) + 15*(raylrnd(0.5) - 0.5));
        elseif mod(i,4) == 2
        xv = max(-mvx , vb(1) + 15 * (raylrnd(0.5) - 0.5));
        yv = min(mvy, vb(2) + 15*(raylrnd(0.5) - 0.5));
        elseif mod(i,4)==3
        xv = min(mvx , vb(1) + 15 * (raylrnd(0.5) - 0.5));
        yv = min(mvy, vb(2) + 15*(raylrnd(0.5) - 0.5));
        end

        zv = max(-mvz, vb(3) + 15*(raylrnd(0.5) - 0.5));
...
%         fileID = fopen(filename,'w');
        for t = 1:10
           ...
           dx = 5*(raylrnd(0.5)-0.5);
           dy = 5*(raylrnd(0.5)-0.5);
           dz = 0.5*(raylrnd(0.5)-0.5);
